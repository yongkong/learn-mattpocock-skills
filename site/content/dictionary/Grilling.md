...
与 <em>agent</em> 一起孕育 <em>design concept</em> 的技法:agent 以穷追不舍的访谈盘问你,一次问完整个还没决定的事的清单(<em>frontier</em>),每题编号并附上推荐答案;一轮 16 个问题很常见,复杂特性 30~50 个也有。它拖住「直奔成品计划」的冲动——概念未稳之前,不写任何 <em>handoff artifact</em>。
...
机制展开与实战见课件 [0002 · 参考层四技能](/lessons/0002)。
